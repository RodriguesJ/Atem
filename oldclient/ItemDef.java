...
public final class ItemDef // load items
{
	...
	public static AbstractSprite getSprite(int i, int j, int k)
	{
		if(k == 0)
		{
			AbstractSprite sprite = (AbstractSprite) mruNodes1.insertFromCache(i);
		...
		AbstractSprite sprite2 = new AbstractSprite(32, 32);
