	...
	private RSModel method452()
	{
		if(desc != null)
		{
			...
			if(super.anim >= 0 && super.anInt1529 == 0)
				j = AbstractAnimation.anims[super.anim].anIntArray353[super.anInt1527];
			else
			if(super.anInt1517 >= 0)
				j = AbstractAnimation.anims[super.anInt1517].anIntArray353[super.anInt1518];
		...
		if(super.anim >= 0 && super.anInt1529 == 0)
		{
			AbstractAnimation animation = AbstractAnimation.anims[super.anim];
		...
		if(super.anInt1517 >= 0)
			k = AbstractAnimation.anims[super.anInt1517].anIntArray353[super.anInt1518];
		...
		if(k != -1 && i1 != -1)
			model_2.method471(AbstractAnimation.anims[super.anim].anIntArray357, i1, k);
		else
		if(k != -1)
			model_2.method470(k);
		model_2.method466();
