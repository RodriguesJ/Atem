package com.runescape.client.revised.media;
...
public final class RSSprite extends DrawingArea {

	public RSSprite(int i, int j)
	{
	...
	public RSSprite(byte abyte0[], Component component)
	{
		try
		{
//			Image image = Toolkit.getDefaultToolkit().getImage(signlink.findcachedir()+"mopar.jpg");
	...
	public RSSprite(CacheArchive streamLoader, String s, int i)
	{
