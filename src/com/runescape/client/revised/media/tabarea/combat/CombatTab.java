package com.runescape.client.revised.media.tabarea.combat;
...
public class CombatTab extends AbstractTab {

	private GamePlayer player;

	public CombatTab(final GamePlayer player) {
	...
	public ImageComponent2D getTabIcon() {
		try {
			return new TextureLoader(new URL("./images/combat_tab_icon.png"), null).getImage();
		} catch (final MalformedURLException murle) {
			murle.printStackTrace();
		}
		return null;
