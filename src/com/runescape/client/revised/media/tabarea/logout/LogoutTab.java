package com.runescape.client.revised.media.tabarea.logout;
...
public class LogoutTab extends AbstractTab {
	...
	public LogoutTab(final GamePlayer player) {
	...
	public ImageComponent2D getTabIcon() {
		try {
			return new TextureLoader(new URL("./images/logout_tab_icon.png"), null).getImage();
		} catch (final MalformedURLException murle) {
			murle.printStackTrace();
		}
		return null;
