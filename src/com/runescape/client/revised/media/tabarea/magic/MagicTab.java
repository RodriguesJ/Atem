package com.runescape.client.revised.media.tabarea.magic;
...
public class MagicTab extends AbstractTab {

	private GamePlayer player;

	public MagicTab(final GamePlayer player) {
	...
	public ImageComponent2D getTabIcon() {
		try {
			return new TextureLoader(new URL("./images/magic_tab_icon.png"), null).getImage();
		} catch (final MalformedURLException murle) {
			murle.printStackTrace();
		}
		return null;
