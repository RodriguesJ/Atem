package com.runescape.client.revised.media.tabarea.prayer;
...
public class PrayerTab extends AbstractTab {

	private GamePlayer player;

	public PrayerTab(final GamePlayer player) {
	...
	public ImageComponent2D getTabIcon() {
		try {
			return new TextureLoader(new URL("./images/prayer_tab_icon.png"), null).getImage();
		} catch (final MalformedURLException murle) {
			murle.printStackTrace();
		}
		return null;
