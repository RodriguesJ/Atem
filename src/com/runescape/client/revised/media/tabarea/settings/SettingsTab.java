package com.runescape.client.revised.media.tabarea.settings;
...
public class SettingsTab extends AbstractTab {
	...
	public SettingsTab(final GamePlayer player) {
	...
	public ImageComponent2D getTabIcon() {
		try {
			return new TextureLoader(new URL("./images/settings_tab_icon.png"), null).getImage();
		} catch (final MalformedURLException murle) {
			murle.printStackTrace();
		}
		return null;
