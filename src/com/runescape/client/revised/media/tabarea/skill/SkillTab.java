package com.runescape.client.revised.media.tabarea.skill;
...
public class SkillTab extends AbstractTab {

	private GamePlayer player;

	public SkillTab(final GamePlayer player) {
	...
	public ImageComponent2D getTabIcon() {
		try {
			return new TextureLoader(new URL("./images/stat_tab_icon.png"), null).getImage();
		} catch (final MalformedURLException murle) {
			murle.printStackTrace();
		}
		return null;
